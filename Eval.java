...
public class Eval {
    ...
    //---------------------------------------------------------------------------
    // There could have some performance problems when the system is big. Any firing requieres checking
    // a lot of transitions, and for each to convert string multisets into multisets. The set of string
    ...
    // and h function
    public Eval(String cap,String h) {
        capStr = cap;
    ...
    public static boolean gef_many(SMultiSet partitionOccBag,String buchForm,String... FormPresAndPosts) {
        ...
        boolean res = gef_one(partitionOccBag,buchForm,robotForm,preMS,postMS);
        numGefs++;
        if (res && (numGefs % 1000000 == 0)) {
            numTrues++;
    ...
    public static boolean gef_one(SMultiSet partitionOccBag,String buchForm,String robotForm,SMultiSet preMS,SMultiSet postMS) {
    ...
    public static boolean gef(SMultiSet partitionOccBag,String buchForm,String robForm1,String PreCap1,String PostCap1) {
        return gef_many(partitionOccBag,buchForm,robForm1,PreCap1,PostCap1);
    }

    public static boolean gef(SMultiSet partitionOccBag,String buchForm,
                              String robotForm1,String PreCap1,String PostCap1,
                              String robotForm2,String PreCap2,String PostCap2) {
        return gef_many(partitionOccBag,buchForm,robotForm1,PreCap1,PostCap1,robotForm2,PreCap2,PostCap2);
    }
    ...
    public static boolean gef(SMultiSet partitionOccBag,String buchForm,
        ...
        return gef_many(partitionOccBag,buchForm,robotForm1,PreCap1,PostCap1,robotForm2,PreCap2,PostCap2,robotForm3,PreCap3,PostCap3);
    }
    //4
    public static boolean gef(SMultiSet partitionOccBag,String buchForm,
                              String robotForm1,String PreCap1,String PostCap1,
    ...
    public static void updateCap_many(SMultiSet partitionOccBag,String... PrePost) {
    ...
    public static void updateCap(SMultiSet partitionOccBag,String pre1,String post1) {
        updateCap_many(partitionOccBag,pre1,post1);
    }

    public static void updateCap(SMultiSet partitionOccBag,String pre1,String post1,String pre2,String post2) {
        updateCap_many(partitionOccBag,pre1,post1,pre2,post2);
    }

    public static void updateCap(SMultiSet partitionOccBag,String pre1,String post1,String pre2,String post2,String pre3,String post3) {
        updateCap_many(partitionOccBag,pre1,post1,pre2,post2,pre3,post3);
    }

    //generated with generate_eval_cap_code.py
    public static void updateCap(
        SMultiSet partitionOccBag,
